...
while ( $resultado=$res->fetch_assoc() ) {
	...
	echo '<a href="aula_show.php?aula='.$resultado['id_ginasio'].'">';
	echo $resultado['aula'];
	echo "</a>";

	echo '  <a href="aula_edit.php?aula='.$resultado['id_ginasio'].'"><strong>Editar</strong></a>';

	echo '  <a  href="aula_delete.php?aula='.$resultado['id_ginasio'].'"><strong>eliminar</strong></a>';
	echo "<br>";
}
$stm->close();
 ?>
